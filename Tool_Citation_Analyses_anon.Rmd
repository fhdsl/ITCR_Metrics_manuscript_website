...
- Note: the category "NA" refers to the that the particular tool did not have an repository or website that allows observation of such tags/metrics. 

 - CI is an acronym for Continuous Integration (regularly merging code changes into a central repository, after which automated builds and tests are run.)
...
```
 ...
 - It appears that the half of the R-packages do not provide instruction on how to cite them. 
 
- "NA" refers to tools with unavailable information on data type. 
